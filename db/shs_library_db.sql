...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2017 at 11:46 AM
...
CREATE DATABASE `shs_library_db`;
USE `shs_library_db`;
--
...
--
-- Indexes for table `authorpublication`
--
ALTER TABLE `authorpublication`
  ADD PRIMARY KEY (`PublicationId`),
  ADD KEY `fk_Publication_has_Author_Author1_idx` (`AuthorId`),
  ADD KEY `fk_Publication_has_Author_Publication_idx` (`PublicationId`);
...
--
ALTER TABLE `publication`
  MODIFY `PublicationId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
-- Constraints for table `authorpublication`
--
ALTER TABLE `authorpublication`
  ADD CONSTRAINT `fk_Publication_has_Author_Author1` FOREIGN KEY (`AuthorId`) REFERENCES `author` (`AuthorId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Publication_has_Author_Publication` FOREIGN KEY (`PublicationId`) REFERENCES `publication` (`PublicationId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
